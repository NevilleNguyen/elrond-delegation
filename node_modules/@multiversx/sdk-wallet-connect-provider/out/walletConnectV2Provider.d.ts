...
import { PairingTypes, SessionTypes, EngineTypes, SignClientTypes } from "@walletconnect/types";
...
export { PairingTypes, SessionTypes, SessionEventTypes, ConnectParamsTypes, EngineTypes, WalletConnectV2ProviderErrorMessagesEnum, };
export declare class WalletConnectV2Provider {
    ...
    constructor(onClientConnect: IClientConnect, chainId: string, walletConnectV2Relay: string, walletConnectV2ProjectId: string, options?: Omit<SignClientTypes.Options, "relayUrl" | "projectId">);
    reset(): void;
    /**
