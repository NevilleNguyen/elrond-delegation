...
import type { TransactionBatchStatusesEnum, TransactionServerStatusesEnum, TransactionTypesEnum } from './enums.types';
...
export declare type RawTransactionType = IPlainTransactionObject;
...
export declare type TransactionsDataTokensType = Record<string, TransactionDataTokenType> | undefined;
interface MultiEsdtType {
    type: TransactionTypesEnum.esdtTransaction | TransactionTypesEnum.nftTransaction;
    receiver: string;
    token?: string;
    nonce?: string;
    amount?: string;
...
export declare type MultiEsdtTransactionType = MultiEsdtType | MultiEsdtScCallType;
...
export interface SendTransactionsPropsType {
    transactions: Transaction | SimpleTransactionType | (Transaction | SimpleTransactionType)[];
