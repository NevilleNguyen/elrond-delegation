...
export declare const TransactionToast: ({ toastId, title, className, onDelete, startTimestamp, endTimeProgress, lifetimeAfterSuccess, status, transactions, customization }: TransactionToastPropsType) => JSX.Element;
