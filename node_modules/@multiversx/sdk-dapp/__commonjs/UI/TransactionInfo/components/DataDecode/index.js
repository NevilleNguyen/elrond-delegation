...
.dapp-core-component__styles__decode .dapp-core-component__styles__warnings .dapp-core-component__styles__warning {
  color: #f0ad4e;
}`;document.head.appendChild(document.createElement("style")).appendChild(document.createTextNode(Gr));var F={decode:"dapp-core-component__styles__decode",textarea:"dapp-core-component__styles__textarea",select:"dapp-core-component__styles__select",dropdown:"dapp-core-component__styles__dropdown",warnings:"dapp-core-component__styles__warnings",icon:"dapp-core-component__styles__icon",warning:"dapp-core-component__styles__warning"};var zr=t=>{let{className:e,value:r}=t,{displayValue:n,validationWarnings:i,setActiveKey:o,decodeOptions:a}=qe(t),l=r&&r!==Pe,p=d=>d?o(d.target.value):"raw";return N.default.createElement("div",{className:F.decode},N.default.createElement("div",{className:(0,Ye.default)(F.textarea,e)},n),l&&N.default.createElement("div",{className:F.select},N.default.createElement("select",{className:F.dropdown,onChange:p},a.map(d=>N.default.createElement("option",{key:d.value,value:d.value},d.label)))),i.map((d,h)=>N.default.createElement("div",{key:h,className:F.warnings},N.default.createElement(Xe.FontAwesomeIcon,{icon:je.faExclamationTriangle,className:F.icon,size:"xs"}),N.default.createElement("small",{className:F.warning},d))))};0&&(module.exports={DataDecode});
/*!
