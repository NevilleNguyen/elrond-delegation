...
export declare const getTransactionsParams: ({ sender, receiver, page, transactionSize, condition, withScResults, after, before, search, status }: GetTransactionsType) => {
