...
export declare const TransactionToastContent: ({ style, toastDataState, transactions, showCloseButton, onDeleteToast, toastTitle, isTimedOut, customElements }: TransactionToastContentProps) => JSX.Element;
